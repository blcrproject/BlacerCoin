...
This mechanism has been integrated into Bitcore-Node-BlacerCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BlacerCoin-Project/insight-api-blacercoin#web-socket-api](https://github.com/BlacerCoin-Project/insight-api-blacercoin#web-socket-api) 
* API: [https://github.com/BlacerCoin-Project/insight-api-blacercoin#swifttx-transactions](https://github.com/BlacerCoin-Project/insight-api-blacercoin#swifttx-transactions) 
...
By default, the BlacerCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BlacerCoin Core daemon:
