...
In order to support loading of multiple wallets in blacercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blacercoin.cpp.
...
Changes to blacercoin.cpp
----------------------
blacercoin.cpp is the entry point into blacercoin-qt, and as such, will require some minor modifications to provide hooks for
