Contributing to BlacerCoin Core
============================

The BlacerCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BlacerCoin Core project, and is not to be
confused with overall BlacerCoin Network Protocol consensus changes.

Whether a pull request is merged into BlacerCoin Core rests with the project merge
...
Patches that change BlacerCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BlacerCoin consensus, it must have been
...
The project leader is the release manager for each BlacerCoin Core release.
