...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BlacerCoin Core"),
     ...
     * override -datadir in the blacercoin.conf file in the default data directory
     * (to be consistent with blacercoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
