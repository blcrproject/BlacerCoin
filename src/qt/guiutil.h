...
/** Utility functions used by the BlacerCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BlacerCoin addresses in monospace font
...
// Parse "blacercoin:" URI into recipient object, return true on successful parsing
