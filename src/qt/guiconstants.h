...
/* Blacercoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BlacerCoin"
#define QAPP_ORG_DOMAIN "blacercoin.cc"
#define QAPP_APP_NAME_DEFAULT "BlacerCoin-Qt"
#define QAPP_APP_NAME_TESTNET "BlacerCoin-Qt-testnet"
