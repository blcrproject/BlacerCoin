                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BlacerCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BlacerCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blacercoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBLCR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BlacerCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BlacerCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BlacerCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BlacerCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BlacerCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BlacerCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BlacerCoin Core help message to get a list with possible BlacerCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BlacerCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlacerCoin network", "", count));
}
...
{
    QString strTitle = tr("BlacerCoin Core"); // default title
