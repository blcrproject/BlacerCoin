...
#ifndef BlacerCoin_INVALID_SERIALS_JSON_H
#define BlacerCoin_INVALID_SERIALS_JSON_H
...
std::string LoadInvalidSerials()
{
    std::string str = "[\n"
            ...
            "  },\n"
            "  {\n"
            "    \"s\": \"1132b139d73a244357d779280060bd07b921b36e4a5d285da2eb2e233f94633ca\"\n"
            "  },\n"
            "  {\n"
...
#endif //BlacerCoin_INVALID_SERIALS_JSON_H
