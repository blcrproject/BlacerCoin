...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Blacercoin Core blacercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blacercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blacercoin transaction") + "\n" +
                               "  blacercoin-tx [options] -create [commands]   " + _("Create hex-encoded blacercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blacercoin transaction
