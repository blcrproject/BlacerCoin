...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BlacerCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BlacerCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BlacerCoin features */
        {"blacercoin", "masternode", &masternode, true, true, false},
        {"blacercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"blacercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blacercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blacercoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"blacercoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"blacercoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"blacercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blacercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"blacercoin", "startmasternode", &startmasternode, true, true, false},
        {"blacercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blacercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blacercoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blacercoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blacercoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blacercoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blacercoin", "mnbudget", &mnbudget, true, true, false},
        {"blacercoin", "preparebudget", &preparebudget, true, true, false},
        {"blacercoin", "submitbudget", &submitbudget, true, true, false},
        {"blacercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blacercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blacercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blacercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blacercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blacercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blacercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blacercoin", "checkbudgets", &checkbudgets, true, true, false},
        {"blacercoin", "mnsync", &mnsync, true, true, false},
        {"blacercoin", "spork", &spork, true, true, false},
        {"blacercoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> blacercoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24432/\n";
}
