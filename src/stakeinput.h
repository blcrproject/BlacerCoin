...
#ifndef BlacerCoin_STAKEINPUT_H
#define BlacerCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZBLCR() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zBLCRStake can take two forms
...
public:
    ...
    bool IsZBLCR() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZBLCR() override { return false; }
};


#endif //BlacerCoin_STAKEINPUT_H
