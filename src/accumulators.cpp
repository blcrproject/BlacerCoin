...
bool ValidateAccumulatorCheckpoint(const CBlock& block, CBlockIndex* pindex, AccumulatorMap& mapAccumulators)
{
    ...
    //It is VERY IMPORTANT that when this is being run and height < v2_start, then zBLCR need to be disabled at the same time!!
...
/*
        // 10 blocks were accumulated twice when zBLCR v2 was activated
