...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/blacercoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/blacercoin-cli.cpp \
           src/blacercoin-tx.cpp \
           src/blacercoin.cpp \
           src/db.cpp \
           ...
           src/qt/blacercoin.cpp \
           src/qt/blacercoinstrings.cpp \
...
RESOURCES += src/qt/blacercoin.qrc src/qt/blacercoin_locale.qrc

TRANSLATIONS += src/qt/locale/blacercoin_bg.ts \
                src/qt/locale/blacercoin_de.ts \
                src/qt/locale/blacercoin_en.ts \
                src/qt/locale/blacercoin_es.ts \
                src/qt/locale/blacercoin_fi.ts \
                src/qt/locale/blacercoin_fr.ts \
                src/qt/locale/blacercoin_it.ts \
                src/qt/locale/blacercoin_ja.ts \
                src/qt/locale/blacercoin_pl.ts \
                src/qt/locale/blacercoin_pt.ts \
                src/qt/locale/blacercoin_ru.ts \
                src/qt/locale/blacercoin_sk.ts \
                src/qt/locale/blacercoin_sv.ts \
                src/qt/locale/blacercoin_vi.ts \
                src/qt/locale/blacercoin_zh_CN.ts \
                src/qt/locale/blacercoin_zh_TW.ts
